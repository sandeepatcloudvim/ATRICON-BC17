report 50000 "Atricon Sales Invoice"
{
    RDLCLayout = './CBRStandardSalesInvoice.rdl';
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                dataitem("Value Entry"; "Value Entry")
                {
                    ...
                    dataitem("Item Ledger Entry"; "Item Ledger Entry")
                    {
                        ...
                        column(Serial_No; "Item Ledger Entry"."Serial No.")
                        {

                        }
                        column(Lot_Qty; ABS("Item Ledger Entry".Quantity))
                        {
                ...
                begin
                    ...
                    ReservEntry.SetRange("Source Ref. No.", Line."Line No.");
                    ...
                    TracSpec.Reset;
                    TracSpec.SetRange("Source ID", Line."Document No.");
                    TracSpec.SetRange("Source Ref. No.", Line."Line No.");
                    TracSpec.SetRange("Item No.", Line."No.");
                    if TracSpec.FindFirst then
                        repeat
                            LotNo := TracSpec."Lot No.";
